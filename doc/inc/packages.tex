...
\newcommand*{\glossarysymbol}[5][]{%First one is newline! Yay!
	\newglossaryentry{#2}{%
		type=symbols,%
		description={#4}, % Für Auflistung
		name={\ensuremath{#3}},% Für Auflistung
		symbol={\ensuremath{#3}},% Für Fließtext \glssymbol
		user1={\ensuremath{\mathrm{#5}}},% Einheit
		sort={#2},%
		#1%damit die Newline verwendet wird?
	}%
}
...
\renewcommand*{\glossaryheader}{%
	...
	\bfseries Beschreibung & \bfseries Seite(n)
...
\usepackage{csquotes}
\MakeAutoQuote{»}{«}
\usepackage[backend=biber,style=alphabetic,maxnames=25,minnames=8]{biblatex}
