...
Der Speicherverbrauch der Listen ist mit maximal 14 \gls{GiB} bei einem \CFDterm{Partikelradiusmultiplikator} von $\glssymbol{cradMod} = 10$ groß. Hinzu kommen vor allem das Vorhalten des Datensatzes der Simulation in Form des \gls{mmpld} im Speicher (über fünf \gls{GiB}).
...
%Falsch, in der Stelle verrutscht: Speicherverbrauch tatsächlich bei 14gb durch die Listen.
